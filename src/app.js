...
require('./config/firebase.config'); // Initialize Firebase (Keep if you need Firebase)
...
// --- NEW: Import Interswitch specific routes ---
const interswitchRoutes = require('./api/v1/payments/interswitch.routes'); // <<< ADD THIS LINE

// --- OPay specific routes (Remove/Comment out if switching completely) ---
// const opayRoutes = require('./api/v1/payments/opay.routes');

// --- Paystack specific routes (Remove/Comment out if switching completely) ---
// const paystackRoutes = require('./api/v1/payments/paystack.routes');
...
// Note: Webhook routes will handle their own JSON parsing with rawBodySaver if needed.
...
// --- NEW: Mount Interswitch specific routes ---
app.use('/api/v1/interswitch', interswitchRoutes); // <<< ADD THIS LINE, new base path

// --- OPay specific routes (Remove/Comment out if switching completely) ---
// app.use('/api/v1/opay', opayRoutes);
